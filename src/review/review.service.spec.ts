...
describe('ReviewService', () => {
    ...
    describe('assignReviewer', () => {
        const user: UserReq = { id: 'user1', email: 'emily@gmail.com', name: 'Emily' };
        ...
        it('Successfully assign a reviewer', async () => {
            jest.spyOn(mockReviewRepository, 'findOne').mockResolvedValueOnce({ id: 'user2' } as any);
    ...
    describe('addReviewToDocument', () => {
        const user: UserReq = { id: 'user2', email: 'jack@gmail.com', name: 'Jack' };
        const documentId = 'doc1';
    ...
    describe('getMyDocumentReviews', () => {
        const user: UserReq = { id: 'user3', email: 'mina@gmail.com', name: 'Mina' };
        const documentId = 'doc1';
